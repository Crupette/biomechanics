...
public class HeartCaseScreenHandler extends ScreenHandler {
    ...
    @Environment(EnvType.CLIENT)
    public int getDepletedBottlesNeeded() { return this.propertyDelegate.get(3); }

    @Environment(EnvType.CLIENT)
    public int getSaturatedBottlesNeeded() { return this.propertyDelegate.get(4); }

    @Environment(EnvType.CLIENT)
    public boolean getHeartAttack() { return this.propertyDelegate.get(2) > 0; }
